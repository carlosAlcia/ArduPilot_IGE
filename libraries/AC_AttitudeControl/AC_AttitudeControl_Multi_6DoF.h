...
public:
    AC_AttitudeControl_Multi_6DoF(AP_AHRS_View &ahrs, const AP_InertialNav& inav, const AP_MultiCopter &aparm, AP_MotorsMulticopter& motors):
        AC_AttitudeControl_Multi(ahrs, inav, aparm,motors) {
